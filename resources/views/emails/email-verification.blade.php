...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <a href="{{ env('FRONTEND_URL') }}/email_verification?token={{ $token }}" class="button">
                {{ __('Verify Email Address') }}
            </a>
            <p>
                {{ __("If you're having trouble clicking the \":actionText\" button, copy and paste the URL below\ninto your web browser:", ['actionText' => __('Verify Email Address')]) }}
            </p>
            <p>
                <a href="{{ env('FRONTEND_URL') }}/email_verification?token={{ $token }}">
                    {{ env('FRONTEND_URL') }}/email_verification?token={{ $token }}
                </a>
            </p>
